...
import 'package:snowflake_client/auth/service/impl/sign-in.service.dart';
import 'package:snowflake_client/auth/service/sign-in.service.dart';
import 'package:tuple/tuple.dart';

final signInControllerProvider =
    StateProvider.family<ISignInController, Tuple2<BuildContext, AuthType?>>(
  (ref, args) => SignInController(ref, args.item1, args.item2),
);

final signInServiceProvider = Provider.autoDispose<ISignInService>((ref) => SignInService(ref));
